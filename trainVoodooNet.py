...
from testVoodooNet_old import VoodooPredictor, VoodooAnalyser

import libVoodoo.TorchModel_old as TM
import libVoodoo.TorchModel as TM2
...
if __name__ == '__main__':
    ...
    if torch_settings['fn'] == 'dbg':
        ...
        train_path = join(data_path, f'20181127-20190927-{torch_settings["fn"]}-10folds_all-ND.zarr')
